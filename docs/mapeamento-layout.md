...
Renderiza o cabeçalho estático do Dashboard.
...
Retorna `html.Div`, container com os três controles de filtragem global.
...
| Componente | ID | Descrição |
|---|---|---|
| `dcc.Graph` | `grafico` | Recebe a figura gerada por `cria_grafico()` via Output do callback `atualizar_tabela_1` |
